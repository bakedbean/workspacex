...
- `wsx repo set-setup | set-archive | edit-setup | edit-archive <repo>` — see [Per-repo setup scripts](../configuration/per-repo-setup-scripts.md)
- `wsx setup install-skill` — see [Agent skill](../integrations/agent-skill.md)
