...
//! dashboard footer, the attached view's top and bottom bars, and the
//! dashboard detail pane's pinned-chip row.
//!
...
pub use bars::{DashboardFooterInputs, cfg, dashboard_detail, dashboard_footer};
